"""Bisect: same as v2_moe196_muon_full_s1337.py but muon_impl='megatron' (old).

Decides: is the +0.2 nat regression a v2-pipeline bug or just a scratch-init
handicap? Old path is the v1.0 known-good Muon code; if this also lands at
~2.99 the regression is intrinsic to scratch init, not v2 pipeline.
"""
out_dir = "/prodcpfs/user/yuchen/scaling_exp/auto_test/v2_muon_OLDPATH_scratch_s1337"
eval_interval = 20000
log_interval = 1
eval_iters = 10
...
use_muon = True
muon_impl = "megatron"   # OLD known-good path for bisect
muon_lr = None
muon_momentum = 0.95
