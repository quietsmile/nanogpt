"""Stage 6B seed 2 — full 7485-iter from scratch refactor-v2, seed=42.

Second seed for 2-seed fleet to match v1.0 3-seed bucket fleet (2.8463 ± 0.0017).
Identical to v2_moe196_full_scratch.py but seed=42.
"""
out_dir = "/prodcpfs/user/yuchen/scaling_exp/auto_test/v2_moe196_full_scratch_s42"
eval_interval = 20000
log_interval = 1
eval_iters = 10
