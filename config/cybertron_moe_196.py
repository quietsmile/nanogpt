...
# I/O
out_dir = 'out-cybertron-moe-196-seqauxfix'
eval_interval = 500
log_interval = 1
eval_iters = 20
eval_only = False
...
gradient_accumulation_steps = 64   # global_batch=64 / (micro_batch=1 × 1 gpu); train.py ÷ world_size
batch_size = 1
block_size = 8192
...
max_iters = 500   # short ablation (full run = 7485 = decay_end_samples/global_batch_size)
