# Same config as cybertron_moe_196_noise1, but init_from='resume' loading
# v10's nano ckpt that was seeded from ref MoE 196 iter_0 weights + Adam step=1.
# Test: does ref-init align nano trajectory to ref (like v10 did)? If yes,
# noise1's +0.35 gap at iter 2000 is scratch-init penalty, not code regression.

out_dir = 'out-cybertron-moe-196-noise1-from-ref'
eval_interval = 20000
log_interval = 1
eval_iters = 10
eval_only = False
...
deterministic = False; seed = 1000
chunked_ce = False; attention_impl = 'te'
