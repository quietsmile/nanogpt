"""v3: enable EOD-aware attention mask (matches ref's flash-attn cu_seqlens behavior).

Identical to cybertron_moe_196_resume_test.py except use_eod_attn_mask=True.
"""
out_dir = 'out-cybertron-moe-196-resume-eodmask'
eval_interval = 200
log_interval = 1
eval_iters = 10
eval_only = False
...
use_eod_attn_mask = True  # v3: EOD-aware attn to match ref's flash-attn cu_seqlens
